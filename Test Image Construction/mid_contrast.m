color_imgs = "C:\Users\irajs\Documents\MATLAB\Color Img Full Set";
binary_imgs = 'Mid Contrast Final Set';

% In case there is no folder or you delete it
if ~isfolder(binary_imgs)
    disp('No Mid Contrast Folder, making one')
    mkdir(binary_imgs)
end
...
for i = 1:numel(color_imgs)
    ...
    thresholdSensitivity = 0.80;            % Adjust as needed
